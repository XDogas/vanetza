#ifndef MCM_FUNCTIONS_HPP_PUFKBEM8
#define MCM_FUNCTIONS_HPP_PUFKBEM8
...
// forward declaration of MCM message wrapper
namespace asn1 { class Mcm; }
 ...
 * \param ASN.1 MCM container (destination)
 */
...
/**
 * Check if a MCM contains only allowed data elements
 * \param mcm MC message
 * \param ssp MC service specific permissions
...
/**
 * Print MCM content with indentation of nested fields
 ...
 */
void print_indented(std::ostream& os, const asn1::Mcm& mcm, const std::string& indent = "\t", unsigned start = 0);

} // namespace facilities
} // namespace vanetza

#endif /* MCM_FUNCTIONS_HPP_PUFKBEM8 */
