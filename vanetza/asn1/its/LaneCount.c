...
int
LaneCount_constraint(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static const ber_tlv_tag_t asn_DEF_LaneCount_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_LaneCount = {
	...
	{
#if !defined(ASN_DISABLE_OER_SUPPORT)
		&asn_OER_type_LaneCount_constr_1,
#endif  /* !defined(ASN_DISABLE_OER_SUPPORT) */
#if !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT)
		&asn_PER_type_LaneCount_constr_1,
#endif  /* !defined(ASN_DISABLE_UPER_SUPPORT) || !defined(ASN_DISABLE_APER_SUPPORT) */
